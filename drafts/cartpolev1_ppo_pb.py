...
import gym
import common.pybullet_env_fix
...
def animate_policy(policy:callable):
  ...
  while not done:
    ...
    image_seq.append(env.render(mode="human"))
...
# %%
test_obj = PPO(env_maker=lambda: gym.make('InvertedPendulumBulletEnv-v0', render_mode="rgb_array"))
test_obj.train()
